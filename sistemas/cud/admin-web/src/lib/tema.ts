// Tema do município (cores + tipografia). Fonte de verdade do design: `marca/` na raiz do monorepo.
// Aqui mantemos uma cópia local enquanto não há um pacote compartilhado (`@pmd/marca`).
// ⚠️ Cores #d1d1b e #1e1ec do manual vieram malformadas — confirmar. Gotham é licenciada (fallback abaixo).
